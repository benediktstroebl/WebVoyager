...
from utils import get_web_element_rect, encode_image, extract_information, print_message,\
    get_webarena_accessibility_tree, get_pdf_retrieval_ans_from_assistant, clip_message_and_obs, clip_message_and_obs_text_only, save_webpage_html
...
def main():
    ...
    weave.init(f"WebVoyager_20240924_17_37_21")
            ...
            while it < args.max_iter:
                ...
                if not fail_obs:
                    ...
                    if (not args.text_only) and args.save_accessibility_tree:
                        ...
                        html_path = os.path.join(task_dir, 'webpage{}'.format(it))
                        save_webpage_html(driver_task, html_path)
